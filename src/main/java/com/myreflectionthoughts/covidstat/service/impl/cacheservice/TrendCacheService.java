...
public class TrendCacheService implements ICacheFacade<String, HashMap<String, Trends>> {
    ...
    private static final Logger logger = Logger.getLogger(TrendCacheService.class.getSimpleName());
        ...
        try {
           String cachedResponse = redisCacheService.get(key);
            if(StringUtils.isNotBlank(cachedResponse)) {
                ...
                trendsMap.put(getEntryKey(key), mappingUtility.parseToPOJO(cachedResponse, Trends.class));
